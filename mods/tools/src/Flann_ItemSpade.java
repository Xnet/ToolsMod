...
public class Flann_ItemSpade extends ItemSpade{
	...
	public Flann_ItemSpade(int id, String displayName, String tex, ItemStack customCraftingMaterial, boolean hasDamage, EnumToolMaterial enumtoolmaterial) {
	...
	public Flann_ItemSpade(int id, String displayName, String tex, Item ccm, EnumToolMaterial enumtoolmaterial){
		this(id, displayName, tex, new ItemStack(ccm), false, enumtoolmaterial);
	}
	
	public Flann_ItemSpade(int id, String displayName, String tex, Block ccm, EnumToolMaterial enumtoolmaterial){
		this(id, displayName, tex, new ItemStack(ccm), false, enumtoolmaterial);
	}
