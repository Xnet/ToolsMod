...
public class Flann_ItemPickaxe extends ItemPickaxe{
	...
	public Flann_ItemPickaxe(int id, String displayName, String tex, ItemStack customCraftingMaterial, boolean hasDamage, EnumToolMaterial enumtoolmaterial) {
	...
	public Flann_ItemPickaxe(int id, String displayName, String tex, Item ccm, EnumToolMaterial enumtoolmaterial){
		this(id, displayName, tex, new ItemStack(ccm), false, enumtoolmaterial);
	}
	
	public Flann_ItemPickaxe(int id, String displayName, String tex, Block ccm, EnumToolMaterial enumtoolmaterial){
		this(id, displayName, tex, new ItemStack(ccm), false, enumtoolmaterial);
	}
